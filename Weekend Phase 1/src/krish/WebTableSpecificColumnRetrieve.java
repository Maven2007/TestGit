...
public class WebTableSpecificColumnRetrieve {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < rows.size(); i++) {
			List<WebElement> col=rows.get(i).findElements(By.tagName("td")); //columns
				...
				System.out.println(driver.findElement(By.xpath("//*[@id='resultTable']/tbody/tr[13]/td[2]")));// Retrieve the specific cell data
			}
		}
	}
